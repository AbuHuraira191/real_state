...
@section('content')
    ...
    <div class="inside-banner">
        <div class="container">
            <span class="pull-right"><a href="{{route('dealer_index')}}">Home</a> /Leading Properties</span>
                        ...
                        @foreach ($properties as $property)
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="properties">
                                    ...
                                    <a class="btn btn-primary" style="margin-top: 5px" href="{{ route('dealer_property_permissions', ['id' => $property['id']]) }}">Set Permissions</a>
                                </div>
                            </div>
                            <!-- properties -->
                        @endforeach
