...
@section('content')
    ...
    <div class="inside-banner">
        <div class="container">
            <span class="pull-right"><a href="{{ route('seller_index') }}">Home</a> / Detail</span>
                ...
                <div class="col-lg-9 col-sm-8 ">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <a class="btn btn-primary" name="Submit" style="margin-top: 10px" href="{{ route('seller_submit_property',['id' => $property['id']]) }}">Edit Property Detail</a>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="col-lg-12 col-sm-6 ">
                                <div class="enquiry">
                                    ...
                                    <form  class="form-inline" role="form" action="{{ route('seller_index') }}" method="GET">
